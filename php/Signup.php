...
if (!empty($fname) && ($lname) && ($email) && ($password) && ($nickname)) {
    if (strlen($nickname) <= 12) {
                           ...
                           if(in_array($img_ext, $extensions) === true){
                               ...
                               if(move_uploaded_file($tmp_name, "../images/".$new_img_name)){
                                   ...
                                   $sql2 = mysqli_query($conn,
                                    "INSERT INTO users (unique_id, fname, lname, email, password, img, status, otp, verification_status, Role, Nickname)
        ...
        $response['message'] = "Nickname should not be more than 12 characters";
    }
} else {
